...
export type LogFilterKey = "result" | "mode" | "first" | "date" | "bot" | "vic" | "char" | "oppChar" | "search";
export const LOG_FILTER_KEYS: LogFilterKey[] = ["result", "mode", "first", "date", "bot", "vic", "char", "oppChar", "search"];
